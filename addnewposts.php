...
if(isset($_POST['submit'])){
    ...
    if(empty($PostTitle)){
        ...
        if($execute){
            $_SESSION["SuccessMessage"]="New Post was added successfully";
    ...
    <section class="container py-2 mb-4">
        <div class="row">
            ...
            <?php 
                ...
                echo SuccessMessage();
            ?>
                <form class="" action="addnewposts.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-body bg-dark text-light">
                            ...
                            <div class="form-group text-light">
                                <div class="custom-file">
                                    ...
                                    <label for="imageselect" class="custom-file-label" aria-describedby="inputGroupFileAddon02">Choose file</label>
                                </div>
                            </div>
                            <div class="form-group text-light">
